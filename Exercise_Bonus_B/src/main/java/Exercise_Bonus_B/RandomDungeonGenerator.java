...
public class RandomDungeonGenerator {
    ...
    private static final int ROOM_MIN_WIDTH = 10;
    private static final int ROOM_MAX_HEIGHT = 100;
    private static final int ROOM_MIN_HEIGHT = 10;
    ...
    private Rectangle generateRandomRectangle(){
        ...
        x = randomNumberGenerator.nextInt(ROOM_X_BOUNDS);
        y = randomNumberGenerator.nextInt(ROOM_Y_BOUNDS);
