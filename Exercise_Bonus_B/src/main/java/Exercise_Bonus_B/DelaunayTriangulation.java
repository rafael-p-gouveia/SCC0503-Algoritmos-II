...
public class DelaunayTriangulation {
    ...
    public static void triangulateGraphVertices(Graph graph)
    {
        ...
        for (int i = 0; i < graph.getNumberOfVertices(); i++) {
            ...
            for (int j = i+1; j < graph.getNumberOfVertices(); j++) {
                ...
                for (int k = j+1; k < graph.getNumberOfVertices(); k++) {
                    var isTriangle = true; //eh um triangulo desejado, isto eh, sem nenhum vertice dentro
    ...
    private static boolean hasNoVerticesInTriangle(Graph graph, Triangle triangle) {
        for (int i = 0; i < graph.getNumberOfVertices(); i++) {
